...
接口路径、请求和响应结构的权威参考。运行时路由、隐私和写入门见上级 `SKILL.md`。

| 接口路径 | 请求 | 响应 |
| --- | --- | --- |
| `openapi/note/v1/search_note` | `SearchNoteReq` | `SearchNoteRsp` |
| `openapi/note/v1/list_note` | `ListNoteReq` | `ListNoteRsp` |
| `openapi/note/v1/get_doc_content` | `GetNoteContentReq` | `GetNoteContentRsp` |
| `openapi/note/v1/import_doc` | `ImportNoteReq` | `ImportNoteRsp` |
| `openapi/note/v1/append_doc` | `AppendNoteReq` | `AppendNoteRsp` |
| `openapi/note/v1/list_notebook` | `ListNoteFolderReq` | `ListNoteFolderRsp` |
