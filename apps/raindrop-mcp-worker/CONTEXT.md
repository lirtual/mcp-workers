...
**Not decided yet**: exact read-only tool groups/names and output schema; SDK-versus-adapter selection; specific protocol conformance cases; final CPU sample counts/statistics and error thresholds; independent v4 endpoint naming and deployment/rollback details; migration approval; and disposition of v3 PR #120 after v4 evidence. No production changes or implementation are authorized by this record.
